...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        _, dW1, db1 = affine_relu_backward(dX1, cache1)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        num_layers = len(layers) - 1 # Since we do not count output as a layer
    ...
    def loss(self, X, y=None):
        ...
        for l in range(num_layers - 1):
            ...
            A, affine_cache = affine_forward(A, W, b)
            ...
            if self.normalization=='batchnorm':
                ...
                A, bn_cache = batchnorm_forward(A, gamma, beta, self.bn_params[l])
        ...
        # Last layer, no ReLU or BatchNorm
        A, affine_cache = affine_forward(A, self.params[f'W{num_layers}'], self.params[f'b{num_layers}'])
        ...
        for i in range(num_layers - 2, -1, -1):
            cache = caches.pop() # [affine, bn, relu]
            if use_dropout:
            ...
            if self.normalization=='batchnorm':
                dX, grads[f'gamma{i+1}'], grads[f'beta{i+1}'] = batchnorm_backward_alt(dX, cache.pop())
